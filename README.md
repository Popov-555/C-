# Лекции С #- обязательны к прочтению
...
[Конструкция if..else и тернарная операция](https://metanit.com/sharp/tutorial/2.5.php)
...
[Возвращение значения и оператор return](https://metanit.com/sharp/tutorial/2.34.php)
[Конструкция switch](https://metanit.com/sharp/tutorial/3.45.php)
...
[Установка пакетов Nuget](https://metanit.com/sharp/tutorial/3.60.php)
...
[Коллекции Список List<T>](https://metanit.com/sharp/tutorial/4.5.php)
...
[Конструкция using](https://metanit.com/sharp/tutorial/8.5.php)
